...
(1+\alpha_\text{G}) \dot{\theta}_k &=& (-1)^k
	\left(
		\Delta\omega_\text{int} \sin\theta_{k+1} \sin\Delta\phi
		+ \epsilon \sigma I \sin\theta_k
	\right)
	- \alpha_\text{G} \omega_\text{FM} \sin\theta_k \cos\theta_k \nn \\
	&+& \alpha_\text{G} \Delta\omega_\text{int}
	\left(
		\sin\theta_k \cos\theta_{k+1}
		- \cos\theta_k \sin\theta_{k+1} \cos\Delta\phi
	\right) \nn \\
(1+\alpha_\text{G}^2)\sin\theta_0 \sin\theta_1 \Delta\dot{\phi} &=&
	\bra{\omega_\text{FM} + \Delta\omega_\text{int}}
		\sin\theta_0 \sin\theta_1 \bra{\cos\theta_0 - \cos\theta_1} \nn \\
	&+& \Delta\omega_\text{int} \cos\Delta\phi\
		\left(
			\cos\theta_0\sin^2\theta_1 - \sin^2\theta_0\cos\theta_1
		\right) \nn \\
	&+& \alpha_\text{G}\Delta\omega_\text{int}\sin\Delta\phi
		\bra{\sin^2\theta_0 + \sin^2\theta_1 }
	+ 2 \alpha_\text{G} \epsilon \sigma I \sin\theta_0\sin\theta_1
\eea
